...
// movimenti) — display/headline tornano al Roboto di sistema (FontFamily.Default), solo più
// pesante. IBM Plex Sans (bundlato come singolo variable font, un solo peso reale incluso)
// resta su title/body/label: non era oggetto del problema segnalato.
