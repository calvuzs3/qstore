...
import net.calvuz.qstore.data.mapper.ArticleImageMapper
import net.calvuz.qstore.data.mapper.ArticleMapper
import net.calvuz.qstore.data.mapper.InventoryMapper
import net.calvuz.qstore.data.mapper.MovementMapper
import net.calvuz.qstore.data.repository.ArticleCategoryRepositoryImpl
import net.calvuz.qstore.data.repository.ArticleRepositoryImpl
import net.calvuz.qstore.data.repository.ImageRecognitionRepositoryImpl
import net.calvuz.qstore.data.repository.MovementRepositoryImpl
import net.calvuz.qstore.domain.repository.ArticleCategoryRepository
import net.calvuz.qstore.domain.repository.ArticleRepository
import net.calvuz.qstore.domain.repository.ImageRecognitionRepository
...
import net.calvuz.qstore.domain.usecase.settings.ApplyRecognitionPresetUseCase
import net.calvuz.qstore.domain.usecase.settings.GetRecognitionSettingsUseCase
import net.calvuz.qstore.domain.usecase.settings.ResetRecognitionSettingsUseCase
import net.calvuz.qstore.domain.usecase.settings.UpdateRecognitionSettingsUseCase
